<%-- 
    Document   : mainpage
    Created on : Mar 10, 2022, 9:19:25 PM
    Author     : predator
--%>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="header__top__right">
                                ...
                                <div class="header__top__right__auth">
                                    <i class="fa fa-user"><a href="MainController?action=Login">Login</a></i>
                                </div>                               
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-3">
                            <div class="featured__item">
                                ...
                                <div class="featured__item__text">
                                    <h6><a href="detail?proID=${p.productID}" title="View Product">"${x.productName}"</a></h6>
                                    <div class="col">
                                        <p class="btn btn-danger btn-block">${x.price} VNĐ</p>
                                    </div>
                                    <div class="col">
