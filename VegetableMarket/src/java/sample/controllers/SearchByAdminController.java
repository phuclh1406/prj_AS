 ...
 * @author predator
 */
@WebServlet(name = "SearchByAdminController", urlPatterns = {"/SearchByAdminController"})
public class SearchByAdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
            String searchByAdmin = request.getParameter("searchByAdmin");
            ProductDAO dao = new ProductDAO();
            List<ProductDTO> listProduct = dao.getProductByNameByAdmin(searchByAdmin);
